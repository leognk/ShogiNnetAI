...
# The values indicated in commentary are those used in Alpha(Go) Zero.
    ...
    def __init__(self):
        ...
        # Number iterations
        self.num_iter = 10 # 700 (= 700,000 / 1,000 ; 700,000 training steps / gradient descent steps)
        self.games_per_iter = 100 # 25,000
        self.epochs_per_iter = 100 # 1e3
        self.games_save_interval = 50
        ...
        self.batch_size = 128 # 700 # 4096
        self.parallel_games = 10**4
        self.state_checkpoint_interval = 20
